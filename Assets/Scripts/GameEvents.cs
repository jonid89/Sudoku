...
public class GameEvents : MonoBehaviour
{
    ...
    public static CheckBoardCompleted OnCheckBoardCompleted;
    ...
    public delegate void GiveCoins();
    public static event GiveCoins OnGiveCoins;

    public static void OnGiveCoinsMethod()
    {
        if (OnGiveCoins != null)
            OnGiveCoins();
    }
    ...
    public delegate void SaveOrReset();
    public static event SaveOrReset OnSaveOrReset;

    public static void OnSaveOrResetMethod()
    {
        if (OnSaveOrReset != null)
            OnSaveOrReset();
    }
