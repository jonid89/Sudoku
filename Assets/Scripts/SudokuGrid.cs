...
public class SudokuGrid : MonoBehaviour
{
    ...
    public Color notes_on_highlight_color = Color.green;
    public Color notes_off_highlight_color = Color.grey;

    private Color line_highlight_color = Color.blue;
    private List<GameObject> grid_squares_ = new List<GameObject>();
    private int selected_grid_data = -1;
    private bool notes_active;
    ...
    private void OnEnable()
    {
        ...
        GameEvents.OnSaveOrReset += SaveOrReset;
    ...
    public void OnSquareSelected(int square_index)
    {
        ...
        if (square_index > -1 && grid_squares_[square_index].GetComponent<GridSquare>().GetHasDefaultValue() == false)
        {
            ...
            if (notes_active) 
                line_highlight_color = notes_on_highlight_color;
            else 
                line_highlight_color = notes_off_highlight_color;
